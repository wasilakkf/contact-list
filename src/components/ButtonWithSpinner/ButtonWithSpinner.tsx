...
export function ButtonWithSpinner({children, showSpinner, onClick, ...buttonProps}: PropsType) {
  return (
    <button type="button" className={styles.button} onClick={onClick} {...buttonProps}>
